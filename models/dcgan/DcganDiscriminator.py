...
class Discriminator(object):
    ...
    def __init__(
        ...
        x = tf.compat.v1.placeholder(tf.compat.v1.float32, shape=(None, sequence_length, sequence_length, 1))
        ...
        # dcgan initializer
            ...
            # concat layer
            cat1 = tf.compat.v1.concat([x, y_fill], 3)
            ...
            # 2nd hidden layer
            conv2 = tf.compat.v1.layers.conv2d(lrelu1, 256, [5, 5], strides=(2, 2), padding='same', kernel_initializer=w_init, bias_initializer=b_init)
