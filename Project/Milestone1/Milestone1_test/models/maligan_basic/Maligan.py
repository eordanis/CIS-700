...
class Maligan(Gan):
    def __init__(self, oracle=None):
        ...
        self.oracle_file = 'models/maligan_basic/save/oracle.txt'
        self.generator_file = 'models/maligan_basic/save/generator.txt'
        self.test_file = 'models/maligan_basic/save/test_file.txt'
