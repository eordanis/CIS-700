...
class OracleGru(object):
    ...
    def create_recurrent_unit(self, params):
        ...
        self.Wf = tf.compat.v1.Variable(tf.compat.v1.random_normal([self.emb_dim, self.hidden_dim], 0.0, 1000000.0, seed=111))
        self.bf = tf.compat.v1.Variable(tf.compat.v1.random_normal([self.hidden_dim, ], 0.0, 1000000.0, seed=311))

        self.Wr = tf.compat.v1.Variable(tf.compat.v1.random_normal([self.emb_dim, self.hidden_dim], 0.0, 1000000.0, seed=112))
        self.br = tf.compat.v1.Variable(tf.compat.v1.random_normal([self.hidden_dim, ], 0.0, 1000000.0, seed=312))

        self.W = tf.compat.v1.Variable(tf.compat.v1.random_normal([self.emb_dim, self.hidden_dim], 0.0, 1000000.0, seed=113))
        ...
        def sru_unit(x, hidden_memory_stack):
            _, previous_c = tf.compat.v1.unstack(hidden_memory_stack)

            # transformation
            xt_ = tf.compat.v1.matmul(x, self.W)

            # forget gate
            ft = tf.compat.v1.sigmoid(
            ...
            # internal state
            ct = tf.compat.v1.multiply(ft, previous_c) + tf.compat.v1.multiply(tf.compat.v1.subtract(1.0, ft), xt_)

            # new memory
            ht = tf.compat.v1.multiply(rt, tf.compat.v1.tanh(ct)) + tf.compat.v1.multiply(tf.compat.v1.subtract(1.0, rt), x)
            ...
            return tf.compat.v1.stack([ht, ct])
    ...
    def create_output_unit(self, params):
        ...
        def unit(hidden_memory_tuple):
            hidden_state, _ = tf.compat.v1.unstack(hidden_memory_tuple)
