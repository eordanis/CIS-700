...
class OracleLstm(object):
    ...
    def create_recurrent_unit(self, params):
        ...
        self.Wi = tf.compat.v1.Variable(tf.compat.v1.random_normal([self.emb_dim, self.hidden_dim], 0.0, 1000000.0, seed=111))
        self.Ui = tf.compat.v1.Variable(tf.compat.v1.random_normal([self.hidden_dim, self.hidden_dim], 0.0, 1000000.0, seed=211))
        self.bi = tf.compat.v1.Variable(tf.compat.v1.random_normal([self.hidden_dim, ], 0.0, 1000000.0, seed=311))

        self.Wf = tf.compat.v1.Variable(tf.compat.v1.random_normal([self.emb_dim, self.hidden_dim], 0.0, 1000000.0, seed=114))
        self.Uf = tf.compat.v1.Variable(tf.compat.v1.random_normal([self.hidden_dim, self.hidden_dim], 0.0, 1000000.0, seed=115))
        self.bf = tf.compat.v1.Variable(tf.compat.v1.random_normal([self.hidden_dim, ], 0.0, 1000000.0, seed=116))

        self.Wog = tf.compat.v1.Variable(tf.compat.v1.random_normal([self.emb_dim, self.hidden_dim], 0.0, 1000000.0, seed=997))
        self.Uog = tf.compat.v1.Variable(tf.compat.v1.random_normal([self.hidden_dim, self.hidden_dim], 0.0, 1000000.0, seed=998))
        self.bog = tf.compat.v1.Variable(tf.compat.v1.random_normal([self.hidden_dim, ], 0.0, 1000000.0, seed=999))

        self.Wc = tf.compat.v1.Variable(tf.compat.v1.random_normal([self.emb_dim, self.hidden_dim], 0.0, 1000000.0, seed=110))
        self.Uc = tf.compat.v1.Variable(tf.compat.v1.random_normal([self.hidden_dim, self.hidden_dim], 0.0, 1000000.0, seed=111))
        self.bc = tf.compat.v1.Variable(tf.compat.v1.random_normal([self.hidden_dim, ], 0.0, 1000000.0, seed=112))
        params.extend([
